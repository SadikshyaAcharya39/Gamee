    ...
    return (
        <nav className="flex justify-between md:justify-around p-5 bg-gray-100">
            ...
            <div className="gap-x-4 hidden md:flex">
                ...
                <Link
                    href="/sign-up"
                    className="flex items-center px-1 py-0 rounded gap-x-1 outline-orange-500 outline outline-offset-2 outline-1 cursor-pointer text-orange-500 hover:text-orange-700"
                >
                    <div>Sign Up</div>
                    <span className="animate-bounce text-orange-500">
